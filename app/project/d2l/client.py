...
class Client(object):
    ...
    def __init__(
        ...
        self.base_url = '{}lite/api/'.format(config['BASE_URL'])
        ...
        for attempt in range(self.retries):
            try:
                ...
                if attempt < self.retries - 1:
                    ...
                    print(f"_request 389: {e.__class__.__name__} {str(e)}")
                    return self.return_error_state(f'{e.__class__.__name__} {str(e)}')

            except Exception as e:
                print(f"_request 393: {attempt} {e.__class__.__name__} {str(e)} {issubclass(e.__class__, BaseError)}")
